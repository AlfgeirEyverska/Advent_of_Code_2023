fn part1() {
    ...
    let file_path = "/Users/ty/Desktop/TKs MBP/Advent_of_Code/day2/input.txt";
    ...
    for line in contents.lines() {
        ...
        for game in info[1].split(";") {
            ...
            for round in game.split(",") {
                ...
                match elements[1] {
                    "red" => if n > red_max { valid = false },
                    "green" => if n > green_max { valid = false },
                    "blue" => if n > blue_max { valid = false },
                    _ => println!("Invalid color!"),
                }
            }
        }
        println!("{id}");
        if valid { valid_sum += id }
    }
    ...
    for line in contents.lines() {
        ...
        for game in info[1].split(";") {
            ...
            for round in game.split(",") {
                ...
                let n: i32 = elements[0].parse().unwrap();
                match elements[1] {
                    "red" => if n > red_max { red_max = n },
                    "green" => if n > green_max { green_max = n },
                    "blue" => if n > blue_max { blue_max = n },
                    _ => println!("Invalid color!"),
                }
            }
        }
